...
protected:
  ...
  cuda::async_unique_ptr<float[]> voxels_d_{nullptr};
  cuda::async_unique_ptr<int[]> coordinates_d_{nullptr};
  cuda::async_unique_ptr<float[]> num_points_per_voxel_d_{nullptr};
  cuda::async_unique_ptr<float[]> encoder_in_features_d_{nullptr};
  cuda::async_unique_ptr<float[]> pillar_features_d_{nullptr};
  cuda::async_unique_ptr<float[]> spatial_features_d_{nullptr};
  cuda::async_unique_ptr<float[]> head_out_heatmap_d_{nullptr};
  cuda::async_unique_ptr<float[]> head_out_offset_d_{nullptr};
  cuda::async_unique_ptr<float[]> head_out_z_d_{nullptr};
  cuda::async_unique_ptr<float[]> head_out_dim_d_{nullptr};
  cuda::async_unique_ptr<float[]> head_out_rot_d_{nullptr};
  cuda::async_unique_ptr<float[]> head_out_vel_d_{nullptr};
  cuda::async_unique_ptr<float[]> points_d_{nullptr};
  cuda::async_unique_ptr<float[]> points_aux_d_{nullptr};
  cuda::async_unique_ptr<float[]> voxels_buffer_d_{nullptr};
  cuda::async_unique_ptr<unsigned int[]> mask_d_{nullptr};
  cuda::async_unique_ptr<unsigned int[]> num_voxels_d_{nullptr};
