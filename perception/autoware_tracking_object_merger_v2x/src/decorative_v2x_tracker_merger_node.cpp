...
#include "autoware/tracking_object_merger_v2x/decorative_v2x_tracker_merger_node.hpp"
  ...
  const TrackedObjects::ConstSharedPtr & main_objects)
{
  ...
  diagnostics_interface_ptr_->publish(tracked_objects_from_states.merged.header.stamp);
}
...
// get merged objects
TrackedObjectsFromStates DecorativeTrackerMergerNode::getTrackedObjects(
...
RCLCPP_COMPONENTS_REGISTER_NODE(autoware::tracking_object_merger_v2x::DecorativeTrackerMergerNode)
