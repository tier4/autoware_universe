...
* chore(perception_utils): install include directory (`#9354 <https://github.com/autowarefoundation/autoware_universe/issues/9354>`_)
* fix: fix ticket links to point to https://github.com/autowarefoundation/autoware_universe (`#9304 <https://github.com/autowarefoundation/autoware_universe/issues/9304>`_)
...
-------------------
* unify package.xml version to 0.37.0
* chore(perception_utils): add unit test (`#8414 <https://github.com/autowarefoundation/autoware_universe/issues/8414>`_)
* feat(perception_utils)!: move perception_utils from common to perception folder (`#8748 <https://github.com/autowarefoundation/autoware_universe/issues/8748>`_)
