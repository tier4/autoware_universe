...
void KnnBatchMlogK::attachToContext(cudnnContext *, cublasContext *, nvinfer1::IGpuAllocator *)
  TRT_NOEXCEPT
{
}
...
nvinfer1::DataType KnnBatchMlogK::getOutputDataType(int, const nvinfer1::DataType *, int) const
  TRT_NOEXCEPT
{
