...
AttentionValueComputation::AttentionValueComputation(const std::string & name, const void *, size_t)
: TRTPluginBase(name)
{
}
...
void AttentionValueComputation::serialize(void *) const TRT_NOEXCEPT
{
}
