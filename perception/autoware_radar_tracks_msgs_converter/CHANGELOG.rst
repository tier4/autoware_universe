...
-------------------
* Merge remote-tracking branch 'origin/main' into tmp/bot/bump_version_base
* fix(autoware_radar_tracks_msgs_converter): fix bugprone-reserved-identifier (`#9658 <https://github.com/autowarefoundation/autoware_universe/issues/9658>`_)
  fix: bugprone-error
...
-------------------
* unify package.xml version to 0.37.0
* fix(docs): fix docs for radar tracks msgs converter (`#8305 <https://github.com/autowarefoundation/autoware_universe/issues/8305>`_)
