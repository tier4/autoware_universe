...
* fix(autoware_object_merger): default merger priority within enum range (`#8858 <https://github.com/tier4/autoware.universe/issues/8858>`_)
  fix: default merger priority within enum range
* fix(object_association_merger_node): fix the frame id of output object msg  (`#8674 <https://github.com/tier4/autoware.universe/issues/8674>`_)
  fix: fix the object msg header
* fix(doc, object_merger): fix object merger document path (`#8292 <https://github.com/tier4/autoware.universe/issues/8292>`_)
  fix object merger document path
* fix(autoware_object_merger): fix passedByValue (`#8232 <https://github.com/tier4/autoware.universe/issues/8232>`_)
  fix:passedByValue
...
* Contributors: Esteve Fernandez, M. Fatih Cırıt, Ryuta Kambe, Taekjin LEE, Yi-Hsiang Fang (Vivid), Yutaka Kondo, Yuxuan Liu, kobayu858
