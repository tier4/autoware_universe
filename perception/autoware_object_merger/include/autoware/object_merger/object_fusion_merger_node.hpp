...
private:
   ...
   * @param fused_objects Output (loaned) message filled with the main-based fused objects.
   * @param other_objects Output (loaned) message filled with the unmatched sub objects.
   */
  void fuse_objects(
