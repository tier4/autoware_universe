...
public:
  ...
  void fromROSMsgAsync(
    const agnocast::ipc_shared_ptr<sensor_msgs::msg::PointCloud2> & msg_ptr)
  {
    // cSpell: ignore knzo25
    // NOTE(knzo25): replace this with the cuda blackboard later
    cudaStreamSynchronize(stream);
    internal_agnocast_msg_ = msg_ptr;
...
private:
  ...
  agnocast::ipc_shared_ptr<sensor_msgs::msg::PointCloud2> internal_agnocast_msg_;
