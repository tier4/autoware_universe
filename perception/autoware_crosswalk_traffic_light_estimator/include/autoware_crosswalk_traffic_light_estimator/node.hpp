...
private:
  ...
  void onRoute(const AUTOWARE_MESSAGE_CONST_SHARED_PTR(LaneletRoute) & msg);
  void onTrafficLightArray(const AUTOWARE_MESSAGE_CONST_SHARED_PTR(TrafficSignalArray) & msg);
