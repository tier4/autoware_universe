...
#ifndef V2I_OBJECT_TRACKER_NODE_HPP_
#define V2I_OBJECT_TRACKER_NODE_HPP_

#include "autoware_v2i_object_tracker/association/data_association.hpp"
...
class V2iObjectTrackerNode : public rclcpp::Node
{
public:
  explicit V2iObjectTrackerNode(const rclcpp::NodeOptions & node_options);
...
#endif  // V2I_OBJECT_TRACKER_NODE_HPP_
