...
{
using autoware::trajectory_optimizer::time_sequence_raw::RoadBorderAvoidance;
using autoware::trajectory_optimizer::time_sequence_raw::RoadBorderAvoidanceParams;
