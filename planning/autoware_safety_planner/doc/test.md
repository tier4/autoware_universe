...
SAFETY_PLANNER_TRAJECTORY_PLANNER_PLUGIN=autoware::safety_planner::experimental::MppiPlanner ./build/autoware_safety_planner/test_autoware_safety_planner_closed_loop
```
