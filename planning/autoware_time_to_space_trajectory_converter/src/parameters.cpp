...
NodeParam init_node_param(rclcpp::Node & node)
{
  ...
  node_param.history_length_m =
    autoware_utils_rclcpp::get_or_declare_parameter<double>(node, "trajectory_history_length_m");
  ...
  node_param.enable_history_stitching =
    autoware_utils_rclcpp::get_or_declare_parameter<bool>(node, "enable_history_stitching");
  ...
  const std::vector<rclcpp::Parameter> & params, NodeParam & node_param)
{
  ...
  try {
    autoware_utils_rclcpp::update_param<double>(
      params, "trajectory_history_length_m", node_param.history_length_m);
    autoware_utils_rclcpp::update_param<double>(
    ...
    autoware_utils_rclcpp::update_param<bool>(
      params, "enable_history_stitching", node_param.enable_history_stitching);
