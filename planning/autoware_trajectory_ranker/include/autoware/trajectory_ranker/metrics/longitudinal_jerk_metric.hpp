...
#ifndef AUTOWARE__TRAJECTORY_RANKER__METRICS__LONGITUDINAL_JERK_METRIC_HPP_
#define AUTOWARE__TRAJECTORY_RANKER__METRICS__LONGITUDINAL_JERK_METRIC_HPP_
...
private:
  trajectory_ranker_params::Params::Evaluation::LongitudinalJerk params_;
};

}  // namespace autoware::trajectory_ranker::metrics

#endif  // AUTOWARE__TRAJECTORY_RANKER__METRICS__LONGITUDINAL_JERK_METRIC_HPP_
