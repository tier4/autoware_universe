...
#ifndef AUTOWARE__TRAJECTORY_RANKER__METRICS__TRAJECTORY_CONSISTENCY_METRIC_HPP_
...
/**
 * @brief Trajectory consistency metric
 *
 * Evaluates the consistency of trajectory endpoints across multiple candidates.
 * Measures lateral variance of trajectory endpoints in the ego vehicle frame.
 * Lower variance indicates more consistent trajectory planning.
 */
class TrajectoryConsistency : public MetricInterface
{
public:
...
#endif  // AUTOWARE__TRAJECTORY_RANKER__METRICS__TRAJECTORY_CONSISTENCY_METRIC_HPP_
