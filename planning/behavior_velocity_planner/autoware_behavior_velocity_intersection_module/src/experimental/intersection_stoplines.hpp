...
#ifndef EXPERIMENTAL__INTERSECTION_STOPLINES_HPP_
#define EXPERIMENTAL__INTERSECTION_STOPLINES_HPP_
...
// clang-format off
#endif  // EXPERIMENTAL__INTERSECTION_STOPLINES_HPP_  // NOLINT
// clang-format on
