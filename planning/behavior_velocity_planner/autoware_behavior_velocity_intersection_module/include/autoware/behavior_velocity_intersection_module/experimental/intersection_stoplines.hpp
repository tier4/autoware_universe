...
#ifndef AUTOWARE__BEHAVIOR_VELOCITY_INTERSECTION_MODULE__EXPERIMENTAL__INTERSECTION_STOPLINES_HPP_
#define AUTOWARE__BEHAVIOR_VELOCITY_INTERSECTION_MODULE__EXPERIMENTAL__INTERSECTION_STOPLINES_HPP_
...
struct IntersectionStopLines
{
   ...
   */
  std::optional<double> stuck_stopline{std::nullopt};
   ...
   */
  std::optional<double> default_stopline{std::nullopt};
   ...
   * - otherwise null (D)
   */
  std::optional<double> collision_stopline{std::nullopt};
   ...
   */
  double first_attention_stopline{0};
   ...
   */
  std::optional<double> maximum_footprint_overshoot_line{std::nullopt};
...
// clang-format off
#endif  // AUTOWARE__BEHAVIOR_VELOCITY_INTERSECTION_MODULE__EXPERIMENTAL__INTERSECTION_STOPLINES_HPP_  // NOLINT
// clang-format on
