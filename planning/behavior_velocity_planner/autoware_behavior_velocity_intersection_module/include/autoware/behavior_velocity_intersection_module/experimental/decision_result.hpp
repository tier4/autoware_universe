...
#ifndef AUTOWARE__BEHAVIOR_VELOCITY_INTERSECTION_MODULE__EXPERIMENTAL__DECISION_RESULT_HPP_
#define AUTOWARE__BEHAVIOR_VELOCITY_INTERSECTION_MODULE__EXPERIMENTAL__DECISION_RESULT_HPP_
...
{
  double closest_s{0};
  double collision_stopline_s{0};
  double occlusion_stopline_s{0};
...
#endif  // AUTOWARE__BEHAVIOR_VELOCITY_INTERSECTION_MODULE__EXPERIMENTAL__DECISION_RESULT_HPP_
