...
* chore(package.xml): bump version to 0.38.0 (`#9266 <https://github.com/tier4/autoware.universe/issues/9266>`_) (`#9284 <https://github.com/tier4/autoware.universe/issues/9284>`_)
  ...
  * 0.38.0
  ---------
* test(virtual_traffic_light): add unit tests for utils (`#9107 <https://github.com/tier4/autoware.universe/issues/9107>`_)
* chore(virtual_traffic_light): add soblin to maintainer (`#9147 <https://github.com/tier4/autoware.universe/issues/9147>`_)
* refactor(virtual_traffic_light): move to utils for unit test (`#9106 <https://github.com/tier4/autoware.universe/issues/9106>`_)
* fix(autoware_behavior_velocity_virtual_traffic_light_module): fix unusedFunction (`#8670 <https://github.com/tier4/autoware.universe/issues/8670>`_)
  fix:unusedFunction
* fix(behavior_velocity_planner): fix cppcheck warnings of virtualCallInConstructor (`#8376 <https://github.com/tier4/autoware.universe/issues/8376>`_)
  Co-authored-by: Ryuta Kambe <ryuta.kambe@tier4.jp>
* fix(autoware_behavior_velocity_virtual_traffic_light_module): fix unusedStructMember (`#8394 <https://github.com/tier4/autoware.universe/issues/8394>`_)
  fix:unusedStructMember
...
* Contributors: Esteve Fernandez, Fumiya Watanabe, Kosuke Takeuchi, M. Fatih Cırıt, Mamoru Sobue, Ryuta Kambe, Takayuki Murooka, Yukinari Hisaki, Yutaka Kondo, kobayu858, taisa1
