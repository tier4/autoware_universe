...
* fix(autoware_behavior_velocity_speed_bump_module): fix uninitMemberVar (`#8319 <https://github.com/autowarefoundation/autoware_universe/issues/8319>`_)
  fix:uninitMemberVar
* feat: add `autoware\_` prefix to `lanelet2_extension` (`#7640 <https://github.com/autowarefoundation/autoware_universe/issues/7640>`_)
* fix(autoware_behavior_velocity_speed_bump_module): fix containerOutOfBounds warning (`#7671 <https://github.com/autowarefoundation/autoware_universe/issues/7671>`_)
