...
* refactor(autoware_behavior_velocity_planner_common,autoware_behavior_velocity_planner): separate param files (`#9470 <https://github.com/tier4/autoware.universe/issues/9470>`_)
  ...
  * fix
  ---------
  Co-authored-by: Kyoichi Sugahara <32741405+kyoichi-sugahara@users.noreply.github.com>
* fix(autoware_behavior_velocity_planner): fix clang-diagnostic-format-security (`#9411 <https://github.com/tier4/autoware.universe/issues/9411>`_)
...
* feat(behavior_velocity_planner): replace first_stop_path_point_index (`#9296 <https://github.com/tier4/autoware.universe/issues/9296>`_)
  ...
  * Update planning/behavior_velocity_planner/autoware_behavior_velocity_planner/src/planner_manager.cpp
  ...
  ---------
  Co-authored-by: Kosuke Takeuchi <kosuke.tnp@gmail.com>
* fix(bvp): remove callback group (`#9294 <https://github.com/tier4/autoware.universe/issues/9294>`_)
...
* chore(package.xml): bump version to 0.38.0 (`#9266 <https://github.com/tier4/autoware.universe/issues/9266>`_) (`#9284 <https://github.com/tier4/autoware.universe/issues/9284>`_)
  ...
  * 0.38.0
  ---------
* fix(bvp): use polling subscriber (`#9242 <https://github.com/tier4/autoware.universe/issues/9242>`_)
  * fix(bvp): use polling subscriber
  * fix: use newest policy
  ---------
* fix(autoware_behavior_velocity_planner): fix passedByValue (`#8213 <https://github.com/tier4/autoware.universe/issues/8213>`_)
  fix:passedByValue
* chore(autoware_behavior_velocity_planner): remove no_prefix function from tests (`#7589 <https://github.com/tier4/autoware.universe/issues/7589>`_)
...
* refactor(behavior_velocity_no_drivable_lane_module): prefix package and namespace with autoware (`#7469 <https://github.com/tier4/autoware.universe/issues/7469>`_)
...
* Contributors: Esteve Fernandez, Fumiya Watanabe, Kosuke Takeuchi, M. Fatih Cırıt, Mamoru Sobue, Satoshi OTA, Takayuki Murooka, Yukinari Hisaki, Yutaka Kondo, kobayu858
