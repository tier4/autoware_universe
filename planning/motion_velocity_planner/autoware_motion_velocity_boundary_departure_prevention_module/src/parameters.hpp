...
struct NodeParam
{
  ...
  explicit NodeParam(rclcpp::Node & node)
  {
    ...
    on_time_buffer_s.departure =
      get_or_declare_parameter<double>(node, module_name + "on_time_buffer_s.departure");
    on_time_buffer_s.near_boundary =
      get_or_declare_parameter<double>(node, module_name + "on_time_buffer_s.near_boundary");
    off_time_buffer_s.departure =
      get_or_declare_parameter<double>(node, module_name + "off_time_buffer_s.departure");
