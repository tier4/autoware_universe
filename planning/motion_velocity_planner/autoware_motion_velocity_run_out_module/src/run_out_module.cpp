...
{
  // diagnostic_updater_.emplace(&node);  // not compatible with agnocast::Node
  ...
  // diagnostic_updater_->setHardwareID("run_out");  // not compatible with agnocast::Node
  // diagnostic_updater_->add(  // not compatible with agnocast::Node
  ...
  const std::shared_ptr<const PlannerData> planner_data)
{
  ...
  // diagnostic_updater_->force_update();  // not compatible with agnocast::Node
