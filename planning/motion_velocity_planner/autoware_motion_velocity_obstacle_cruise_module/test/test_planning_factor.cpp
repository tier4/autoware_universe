...
TEST(PlanningFactorTest, NodeTestWithPredictedObjects)
{
  ...
  const auto plugin_info_vec = {autoware::motion_velocity_planner::PluginInfo{
    "obstacle_cruise", "autoware::motion_velocity_planner::ObstacleCruiseModule"}};
  ...
  const std::string output_planning_factors_topic = "planning/planning_factors/obstacle_cruise";
  ...
  // Add a simple car obstacle for testing
  ...
  // Set pose - place car in front of ego
  geometry_msgs::msg::Pose initial_pose;
  initial_pose.position.x = 30.0;
