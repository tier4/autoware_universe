...
The node publishes raw diffusion trajectories. The downstream `autoware_trajectory_modifier` pipeline applies optional optimizers, including MPPI, and safety modifiers.
...
+      </include>
+      <include file="$(find-pkg-share autoware_trajectory_modifier)/launch/trajectory_optimizer.launch.xml">
