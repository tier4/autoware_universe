...
class MppiDebugVisualizer(Node):
    def __init__(self, *, topic_prefix: str, update_hz: float, wheel_base: float) -> None:
        ...
        gs = gridspec.GridSpec(3, 2, figure=self._fig, width_ratios=[1.2, 1.0], wspace=0.28, hspace=0.35)
        ...
        self._ax_steer = self._ax_accel.twinx()
        ...
        self.get_logger().info("Subscriptions use BEST_EFFORT QoS.")
    ...
    def on_timer(self) -> None:
        ...
        if n_compare > 0:
            ...
            self._ax_accel.legend(lines_a + lines_s, labels_a + labels_s, loc="best")
...
def parse_args(argv: List[str]) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=float,
        default=2.79,
        help="Wheel base [m] used to derive steering from path curvature when unset",
    )
