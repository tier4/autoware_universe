...
inline constexpr std::array<int64_t, 3> EGO_AGENT_FUTURE_SHAPE = {1, OUTPUT_T, POSE_DIM};
inline constexpr std::array<int64_t, 3> EGO_VELOCITY_FUTURE_SHAPE = {1, OUTPUT_T, 1};
