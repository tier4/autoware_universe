...
* refactor(route_handler)!: rename to include/autoware/{package_name}  (`#7530 <https://github.com/tier4/autoware.universe/issues/7530>`_)
  refactor(route_handler)!: rename to include/autoware/{package_name}
* feat(scenario_selector): rename to include/autoware/{package_name} (`#7512 <https://github.com/tier4/autoware.universe/issues/7512>`_)
* refactor(test_utils): move to common folder (`#7158 <https://github.com/tier4/autoware.universe/issues/7158>`_)
  ...
  * remove namespace from planning validator, it has using keyword
  ---------
* feat(scenario_selector): use polling subscribers (`#7412 <https://github.com/tier4/autoware.universe/issues/7412>`_)
...
* Contributors: Esteve Fernandez, Kazunori-Nakajima, Kosuke Takeuchi, M. Fatih Cırıt, Maxime CLEMENT, Takayuki Murooka, Yukinari Hisaki, Yutaka Kondo, Zulfaqar Azmi, mkquda
