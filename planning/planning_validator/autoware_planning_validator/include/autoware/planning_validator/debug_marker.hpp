...
public:
  ...
  void pushPointMarker(const geometry_msgs::msg::Point & point, const std::string & ns, int id = 0, double scale = 0.3, bool is_cube = false);
  ...
  void pushLineSegmentMarker(
    const geometry_msgs::msg::Point & p1, const geometry_msgs::msg::Point & p2, const std::string & ns, int id = 0);
