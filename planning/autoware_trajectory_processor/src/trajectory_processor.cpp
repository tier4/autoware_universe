  ...
  context_{std::make_shared<TrajectoryProcessorContext>(this)}
{
  ...
  sub_current_steering_ =
    namespace_polling::create_polling_subscriber<SteeringReport>(this, "~/input/steering_status");
  sub_objects_ =
    namespace_polling::create_polling_subscriber<PredictedObjects>(this, "~/input/objects");
  sub_tracked_objects_ =
    namespace_polling::create_polling_subscriber<TrackedObjects>(this, "~/input/tracked_objects");
