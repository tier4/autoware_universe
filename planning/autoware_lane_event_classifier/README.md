...
!!! note
    ...
    A **route primitive** is the sequence of lanes, the planned path, that the ego will try to drive on

with best effort. So "is this lane a route primitive?" asks whether the lane is part of that path.
