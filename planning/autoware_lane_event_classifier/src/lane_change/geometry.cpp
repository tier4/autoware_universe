  ...
  const LaneTracker & tracker, const LaneEventInput & input) const
{
  ...
  // feed both the confidence booster and the settle check. Recomputing either (an R-tree footprint
  // search, or the trajectory walk) per helper dominated the cycle cost.
