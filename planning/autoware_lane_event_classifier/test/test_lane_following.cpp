...
// Tests for the lane-following gate (LaneFollowingChecker) — the rules and patterns from
// docs/lane_following.md, on both synthetic maps and the real test map (test/map). The gate
...
namespace
{
// Evaluates the lane-following gate for the ego reference point against the tracker's held
// reference lane.
