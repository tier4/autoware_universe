...
* test(autoware_behavior_path_side_shift_module): add unit tests for util function (`#9540 <https://github.com/tier4/autoware.universe/issues/9540>`_)
  test(side_shift_module): add unit tests
* refactor(autoware_behavior_path_side_shift_module): refactor shift length retrieval and improve path orientation handling (`#9539 <https://github.com/tier4/autoware.universe/issues/9539>`_)
...
* fix(autoware_behavior_path_side_shift_module): fix unusedFunction (`#8655 <https://github.com/tier4/autoware.universe/issues/8655>`_)
  fix:unusedFunction
...
* refactor(behaivor_path_planner)!: rename to include/autoware/{package_name} (`#7522 <https://github.com/tier4/autoware.universe/issues/7522>`_)
  ...
  * fix build
  ---------
* Contributors: Esteve Fernandez, Go Sakayori, Kosuke Takeuchi, Kyoichi Sugahara, M. Fatih Cırıt, Satoshi OTA, Takayuki Murooka, Yutaka Kondo, kobayu858
