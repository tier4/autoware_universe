...
/**
 * @brief Apply a cubic lateral shift toward the route goal on the terminal path segment.
 * @return Shifted path on success; std::nullopt if validation fails (caller keeps reference path).
 */
