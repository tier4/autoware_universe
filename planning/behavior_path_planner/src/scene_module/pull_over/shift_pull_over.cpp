  ...
  const double shoulder_left_bound_to_goal_distance) const
{
  ...
  // generate shift_point and set it to path_sifter
  ShiftPoint shift_point{};
  {
    shift_point.start = shift_start_pose;
    shift_point.end = shift_end_pose;
    ...
    shift_point.length = goal_to_shift_start_distance;
