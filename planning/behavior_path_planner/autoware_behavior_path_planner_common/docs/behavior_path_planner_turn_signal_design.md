...
| turn_signal_remaining_distance_to_bound_threshold | [m]  | double | The turn signal will be turned off when the lateral distance from the ego's edge to the nearest boundary is less than the threshold. | 1.4           |
