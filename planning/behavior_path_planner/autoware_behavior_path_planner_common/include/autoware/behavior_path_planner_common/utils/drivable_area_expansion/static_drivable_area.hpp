...
/**
 * @brief Check if the given lanes contain K-turn environment (direction_change_area tag)
 ...
 * @param [inout] path path whose drivable area is generated
 * @param [in] lanes lanes used for drivable area generation
