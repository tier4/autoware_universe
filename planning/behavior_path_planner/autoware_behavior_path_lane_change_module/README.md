...
| `frenet.use_entire_remaining_distance` | [-]   | bool   | Flag to configure lc length, if true frenet will use entire remaining distance to lane end for lc path generation                                   | false         |
