...
rclcpp::NodeOptions GoalPlannerTestHelper::make_node_options()
{
  ...
  const auto goal_planner_param_path = get_absolute_path_to_config(
    "autoware_behavior_path_goal_planner_module", "goal_planner.param.yaml");
  ...
  autoware::test_utils::updateNodeOptions(
    node_options, {common_param_path, nearest_search_param_path, vehicle_info_param_path,
                   ...
                   scene_module_manager_param_path, goal_planner_param_path});

  return node_options;
}

void GoalPlannerTestHelper::set_odometry(
...
void GoalPlannerTestHelper::set_route(
...
void GoalPlannerTestHelper::set_costmap(
  std::shared_ptr<PlannerData> & planner_data, const geometry_msgs::msg::Pose & start_pose,
