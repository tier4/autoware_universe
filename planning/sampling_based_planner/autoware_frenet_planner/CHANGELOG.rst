...
* fix(sampling_based_planner): remove unmatched suppression (`#10700 <https://github.com/autowarefoundation/autoware_universe/issues/10700>`_)
...
-------------------
* unify package.xml version to 0.37.0
* fix(autoware_frenet_planner): fix build error (`#8807 <https://github.com/autowarefoundation/autoware_universe/issues/8807>`_)
  fix:build error
* fix(autoware_frenet_planner): fix unusedFunction (`#8788 <https://github.com/autowarefoundation/autoware_universe/issues/8788>`_)
  fix: unusedFunction
