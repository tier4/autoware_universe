...
* refactor(autoware_interpolation): prefix package and namespace with autoware (`#8088 <https://github.com/tier4/autoware.universe/issues/8088>`_)
  Co-authored-by: kosuke55 <kosuke.tnp@gmail.com>
* fix(autoware_path_sampler): fix unusedFunction (`#8730 <https://github.com/tier4/autoware.universe/issues/8730>`_)
  fix:unusedFunction
* fix(autoware_path_sampler): fix passedByValue (`#8216 <https://github.com/tier4/autoware.universe/issues/8216>`_)
  fix:passedByValue
* refactor(universe_utils/motion_utils)!: add autoware namespace (`#7594 <https://github.com/tier4/autoware.universe/issues/7594>`_)
* fix(autoware_path_sampler): fix unusedVariable warning (`#7584 <https://github.com/tier4/autoware.universe/issues/7584>`_)
  fix unusedVariable warning
...
* ci(pre-commit): autoupdate (`#7499 <https://github.com/tier4/autoware.universe/issues/7499>`_)
  Co-authored-by: M. Fatih Cırıt <mfc@leodrive.ai>
* feat(sampling_based_planner): use polling subscribers (`#7394 <https://github.com/tier4/autoware.universe/issues/7394>`_)
...
* Contributors: Esteve Fernandez, Kosuke Takeuchi, M. Fatih Cırıt, Maxime CLEMENT, Ryuta Kambe, Satoshi OTA, Takayuki Murooka, Yutaka Kondo, awf-autoware-bot[bot], kobayu858
