...
* chore(package.xml): bump version to 0.38.0 (`#9266 <https://github.com/tier4/autoware.universe/issues/9266>`_) (`#9284 <https://github.com/tier4/autoware.universe/issues/9284>`_)
  ...
  * 0.38.0
  ---------
* fix(autoware_route_handler): fix cppcheck unusedVariable (`#9191 <https://github.com/tier4/autoware.universe/issues/9191>`_)
...
* test(autoware_route_handler): add unit test for autoware route handler function (`#8271 <https://github.com/tier4/autoware.universe/issues/8271>`_)
  ...
  * add test case for getCenterLinePath to improve branch coverage
  ---------
* fix(route_handler): make new route continuous with previous route (`#8238 <https://github.com/tier4/autoware.universe/issues/8238>`_)
* feat(map_loader, route_handler)!: add format_version validation (`#7074 <https://github.com/tier4/autoware.universe/issues/7074>`_)
  Co-authored-by: Yamato Ando <yamato.ando@gmail.com>
...
* refactor(route_handler)!: rename to include/autoware/{package_name}  (`#7530 <https://github.com/tier4/autoware.universe/issues/7530>`_)
  refactor(route_handler)!: rename to include/autoware/{package_name}
* chore(route_handler, lane_change): add codeowner (`#7475 <https://github.com/tier4/autoware.universe/issues/7475>`_)
...
* refactor(route_handler): route handler add autoware prefix (`#7341 <https://github.com/tier4/autoware.universe/issues/7341>`_)
  ...
  * keep header and source file name as before
  ---------
* Contributors: Esteve Fernandez, Fumiya Watanabe, Kosuke Takeuchi, M. Fatih Cırıt, Mamoru Sobue, Ryuta Kambe, Takayuki Murooka, Yutaka Kondo, Zulfaqar Azmi, mkquda
