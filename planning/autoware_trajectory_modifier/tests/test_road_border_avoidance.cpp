...
{
using autoware::trajectory_modifier::time_sequence_raw::RoadBorderAvoidance;
using autoware::trajectory_modifier::time_sequence_raw::RoadBorderAvoidanceParams;
