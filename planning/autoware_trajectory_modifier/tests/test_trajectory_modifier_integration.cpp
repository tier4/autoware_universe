...
class TrajectoryModifierIntegrationTest : public ::testing::Test
{
protected:
  ...
  void SetUp() override
  {
    ...
    modifier_options.append_parameter_override(
      "trajectory_velocity_optimizer.smooth_velocities", true);

    modifier_options.arguments(
      {"--ros-args",
       "--params-file",
       modifier_dir + "/config/trajectory_modifier.param.yaml",
       "--params-file",
       core_planning_dir + "/config/common.param.yaml",
       "--params-file",
       modifier_dir + "/config/trajectory_smoothing/elastic_band_smoother.param.yaml",
       "--params-file",
       modifier_dir + "/config/plugins/trajectory_qp_smoother.param.yaml",
       "--params-file",
       modifier_dir + "/config/plugins/trajectory_point_fixer.param.yaml",
       "--params-file",
       modifier_dir + "/config/plugins/trajectory_velocity_optimizer.param.yaml",
       "--params-file",
       modifier_dir + "/config/plugins/trajectory_extender.param.yaml",
       "--params-file",
       modifier_dir + "/config/plugins/trajectory_spline_smoother.param.yaml",
       "--params-file",
       modifier_dir + "/config/plugins/trajectory_kinematic_feasibility_enforcer.param.yaml",
       "--params-file",
       modifier_dir + "/config/plugins/trajectory_mpt_optimizer.param.yaml",
       "--params-file",
       modifier_dir + "/config/plugins/trajectory_temporal_mpt_optimizer.param.yaml",
       "--params-file",
    ...
    sub_output_ = test_node_->create_subscription<Trajectory>(
      "/trajectory_modifier/output/trajectory", 1, [this](const Trajectory::ConstSharedPtr msg) {
        output_received_ = true;
        latest_output_ = *msg;
      });
    sub_candidate_output_ = test_node_->create_subscription<CandidateTrajectories>(
      "/trajectory_modifier/output/trajectories", 1,
...
TEST_F(TrajectoryModifierIntegrationTest, RejectsInputWithoutRequiredState)
{
...
TEST_F(TrajectoryModifierIntegrationTest, PublishesEmptyCandidateArrayWithoutSelectedTrajectory)
{
...
TEST_F(TrajectoryModifierIntegrationTest, AppliesFallbackToEveryShortCandidate)
{
...
TEST_F(TrajectoryModifierIntegrationTest, BasicPipelineTest)
{
...
TEST_F(TrajectoryModifierIntegrationTest, ObstacleStopIntegrationTest)
{
...
TEST_F(TrajectoryModifierIntegrationTest, StopPointFixerIntegrationTest)
{
...
TEST_F(TrajectoryModifierIntegrationTest, KinematicFeasibilityTest)
{
...
TEST_F(TrajectoryModifierIntegrationTest, VelocityOptimizationTest)
{
...
TEST_F(TrajectoryModifierIntegrationTest, SmoothObstacleStopInteractionTest)
{
...
TEST_F(TrajectoryModifierIntegrationTest, ObstacleStopAndSmoothDecelerationTest)
{
...
TEST_F(TrajectoryModifierIntegrationTest, StopPointFixerAndOptimizerResamplingTest)
{
