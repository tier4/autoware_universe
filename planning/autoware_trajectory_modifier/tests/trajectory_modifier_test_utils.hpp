...
bool process_plugin(
  Plugin & modifier_plugin, plugin::TrajectoryPoints & trajectory, TrajectoryModifierData data)
{
  return modifier_plugin.process(trajectory, data) == plugin::ProcessingResult::Modified;
}
