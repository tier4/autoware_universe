...
{
public:
  /// @brief Construct the modifier node and load its configured plugin pipeline.
...
private:
  ...
  using Plugin = plugin::TrajectoryModifierPluginBase;
  ...
  tl::expected<TrajectoryModifierData, std::string> make_input_data();
