...
#ifndef AUTOWARE__TRAJECTORY_MODIFIER__TRAJECTORY_MODIFIER_PLUGIN_BASE_HPP_
#define AUTOWARE__TRAJECTORY_MODIFIER__TRAJECTORY_MODIFIER_PLUGIN_BASE_HPP_
...
public:
  ...
  TrajectoryModifierPluginBase(const TrajectoryModifierPluginBase &) = delete;
  TrajectoryModifierPluginBase & operator=(const TrajectoryModifierPluginBase &) = delete;
  TrajectoryModifierPluginBase(TrajectoryModifierPluginBase &&) = delete;
  TrajectoryModifierPluginBase & operator=(TrajectoryModifierPluginBase &&) = delete;
  ...
  void initialize(
    ...
    std::shared_ptr<TrajectoryModifierContext> context, const TrajectoryModifierParams & params)
  {
    ...
    RCLCPP_DEBUG(
      node_ptr_->get_logger(), "Instantiated trajectory modifier plugin '%s' as '%s'",
  ...
  /// @brief Apply an updated snapshot of modifier parameters.
...
#endif  // AUTOWARE__TRAJECTORY_MODIFIER__TRAJECTORY_MODIFIER_PLUGIN_BASE_HPP_
