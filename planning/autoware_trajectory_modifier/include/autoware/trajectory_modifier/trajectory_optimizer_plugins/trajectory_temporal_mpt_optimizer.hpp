...
#ifndef AUTOWARE__TRAJECTORY_MODIFIER__TRAJECTORY_OPTIMIZER_PLUGINS__TRAJECTORY_TEMPORAL_MPT_OPTIMIZER_HPP_  // NOLINT
#define AUTOWARE__TRAJECTORY_MODIFIER__TRAJECTORY_OPTIMIZER_PLUGINS__TRAJECTORY_TEMPORAL_MPT_OPTIMIZER_HPP_  // NOLINT

#include "autoware/trajectory_modifier/acados_interface.hpp"
...
class TrajectoryTemporalMPTOptimizer : public TrajectoryModifierPluginBase
{
public:
...
private:
  ...
  void set_mpt_params(
    const trajectory_modifier_params::Params::TrajectoryTemporalMptOptimizer & params);
  ...
  rclcpp::Publisher<std_msgs::msg::Float64MultiArray>::SharedPtr debug_control_delta_cmd_pub_;
   ...
   // clang-format off
#endif  // AUTOWARE__TRAJECTORY_MODIFIER__TRAJECTORY_OPTIMIZER_PLUGINS__TRAJECTORY_TEMPORAL_MPT_OPTIMIZER_HPP_  // NOLINT
// clang-format on
