...
#ifndef AUTOWARE__TRAJECTORY_MODIFIER__TRAJECTORY_OPTIMIZER_PLUGINS__TRAJECTORY_TIME_SEQUENCE_RAW_OPTIMIZER_HPP_  // NOLINT
#define AUTOWARE__TRAJECTORY_MODIFIER__TRAJECTORY_OPTIMIZER_PLUGINS__TRAJECTORY_TIME_SEQUENCE_RAW_OPTIMIZER_HPP_  // NOLINT

#include "autoware/trajectory_modifier/time_sequence_raw/road_border_avoidance.hpp"
#include "autoware/trajectory_modifier/time_sequence_raw/stamped_ego_buffer.hpp"
...
class TrajectoryTimeSequenceRawOptimizer : public TrajectoryModifierPluginBase
{
public:
...
private:
  void set_params(const TrajectoryModifierParams & params);
  void ensure_optimizer();
  void ensure_ego_subscriptions();
  void maybe_update_map(const TrajectoryModifierData & data);
  void ensure_debug_publishers();
  void ingest_live_ego(const TrajectoryModifierData & data);
...
// clang-format off
#endif  // AUTOWARE__TRAJECTORY_MODIFIER__TRAJECTORY_OPTIMIZER_PLUGINS__TRAJECTORY_TIME_SEQUENCE_RAW_OPTIMIZER_HPP_  // NOLINT
// clang-format on
