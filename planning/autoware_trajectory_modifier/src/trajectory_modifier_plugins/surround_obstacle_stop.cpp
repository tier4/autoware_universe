...
bool SurroundObstacleStop::check_inputs(const TrajectoryModifierData & input) const
{
...
bool SurroundObstacleStop::is_obstacle_nearby(const TrajectoryModifierData & input)
{
