...
#include "autoware/trajectory_modifier/trajectory_optimizer_plugins/trajectory_velocity_optimizer.hpp"

#include "autoware/trajectory_modifier/trajectory_optimizer_plugins/plugin_utils/trajectory_velocity_optimizer_utils.hpp"
...
void TrajectoryVelocityOptimizer::on_initialize(const TrajectoryModifierParams & params)
{
...
void TrajectoryVelocityOptimizer::update_params(const TrajectoryModifierParams & params)
{
  enabled_ = params.use_velocity_optimizer;
  velocity_params_.nearest_dist_threshold_m =
    params.trajectory_velocity_optimizer.nearest_dist_threshold_m;
