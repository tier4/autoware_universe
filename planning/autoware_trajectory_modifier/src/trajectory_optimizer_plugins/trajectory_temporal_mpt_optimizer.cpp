...
#include "autoware/trajectory_modifier/trajectory_optimizer_plugins/trajectory_temporal_mpt_optimizer.hpp"
...
void TrajectoryTemporalMPTOptimizer::on_initialize(const TrajectoryModifierParams & params)
{
...
void TrajectoryTemporalMPTOptimizer::update_params(const TrajectoryModifierParams & params)
{
