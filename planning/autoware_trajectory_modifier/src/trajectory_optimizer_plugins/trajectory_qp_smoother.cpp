...
#include "autoware/trajectory_modifier/trajectory_optimizer_plugins/trajectory_qp_smoother.hpp"
...
void TrajectoryQPSmoother::on_initialize(const TrajectoryModifierParams & params)
{
...
void TrajectoryQPSmoother::update_params(const TrajectoryModifierParams & params)
{
  enabled_ = params.use_qp_smoother;
  qp_params_ = params.trajectory_qp_smoother;
}
