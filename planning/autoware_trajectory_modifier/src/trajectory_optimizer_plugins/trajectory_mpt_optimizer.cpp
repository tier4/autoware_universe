...
#include "autoware/trajectory_modifier/trajectory_optimizer_plugins/trajectory_mpt_optimizer.hpp"
...
void TrajectoryMPTOptimizer::on_initialize(const TrajectoryModifierParams & params)
{
...
void TrajectoryMPTOptimizer::update_params(const TrajectoryModifierParams & params)
{
  enabled_ = params.use_mpt_optimizer;
