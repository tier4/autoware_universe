...
#include "autoware/trajectory_modifier/trajectory_optimizer_plugins/trajectory_eb_smoother_optimizer.hpp"
...
void TrajectoryEBSmootherOptimizer::on_initialize(const TrajectoryModifierParams & params)
{
...
void TrajectoryEBSmootherOptimizer::update_params(const TrajectoryModifierParams & params)
{
  enabled_ = params.use_eb_smoother;
