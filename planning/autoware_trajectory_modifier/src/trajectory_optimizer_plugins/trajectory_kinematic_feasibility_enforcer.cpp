...
#include "autoware/trajectory_modifier/trajectory_optimizer_plugins/trajectory_kinematic_feasibility_enforcer.hpp"
...
void TrajectoryKinematicFeasibilityEnforcer::on_initialize(const TrajectoryModifierParams & params)
{
...
void TrajectoryKinematicFeasibilityEnforcer::update_params(const TrajectoryModifierParams & params)
{
  enabled_ = params.use_kinematic_feasibility_enforcer;
  feasibility_params_ = params.trajectory_kinematic_feasibility;
}
