...
```bash
ros2 run autoware_trajectory_modifier autoware_trajectory_optimizer_node --ros-args --log-level trajectory_optimizer:=debug
```
...
- Parent Package: `autoware_trajectory_modifier`
