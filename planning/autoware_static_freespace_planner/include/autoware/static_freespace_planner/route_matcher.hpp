...
#ifndef AUTOWARE_STATIC_FREESPACE_PLANNER_ROUTE_MATCHER_HPP_
#define AUTOWARE_STATIC_FREESPACE_PLANNER_ROUTE_MATCHER_HPP_
...
public:
  RouteMatcher(
    const std::vector<RouteIndexLoader::RouteDefinition>& routes,
...
#endif // AUTOWARE_STATIC_FREESPACE_PLANNER_ROUTE_MATCHER_HPP_