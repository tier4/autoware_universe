...
* fix(motion_planning): align the parameters with launcher (`#8792 <https://github.com/tier4/autoware.universe/issues/8792>`_)
  parameters in motion_planning aligned
* fix(autoware_path_smoother): fix passedByValue (`#8203 <https://github.com/tier4/autoware.universe/issues/8203>`_)
  fix:passedByValue
...
* refactor(path_smoother)!: prefix package and namespace with autoware (`#7381 <https://github.com/tier4/autoware.universe/issues/7381>`_)
  ...
  * fix
  ---------
* Contributors: Esteve Fernandez, Kosuke Takeuchi, M. Fatih Cırıt, Takayuki Murooka, Yutaka Kondo, Zhe Shen, Zulfaqar Azmi, kobayu858
