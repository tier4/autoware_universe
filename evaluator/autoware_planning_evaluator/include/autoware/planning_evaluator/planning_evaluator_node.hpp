...
private:
  ...
  autoware::agnocast_wrapper::polling::PollingSubscriber<ValidationReportArray>::SharedPtr
    validation_reports_sub_ =
      autoware::agnocast_wrapper::polling::create_polling_subscriber<ValidationReportArray>(
