...
void ControlEvaluatorNode::AddUncrossableBoundaryDistanceMetricMsg(const Pose & ego_pose)
{
  ...
  AddMetricMsg(
    metric_left_count, static_cast<double>(uncrossable_left_nonpositive_event_count_), true);
  ...
  AddMetricMsg(
    metric_right_count, static_cast<double>(uncrossable_right_nonpositive_event_count_), true);
}
