...
void ControlEvaluatorNode::AddUncrossableBoundaryDistanceMetricMsg(const Pose & ego_pose)
{
  ...
  const auto update_nonpositive_event_count =
  ...
  update_nonpositive_event_count(
    nearest_left, uncrossable_left_nonpositive_armed_, uncrossable_left_nonpositive_event_count_);
  update_nonpositive_event_count(
    nearest_right, uncrossable_right_nonpositive_armed_,
    uncrossable_right_nonpositive_event_count_);
  ...
  AddMetricMsg(metric_left_count, static_cast<double>(uncrossable_left_nonpositive_event_count_), false);
  ...
  AddMetricMsg(metric_right_count, static_cast<double>(uncrossable_right_nonpositive_event_count_), false);
}
