...
enum class Metric {
  ...
  left_uncrossable_boundary_distance_count,
  right_uncrossable_boundary_distance,
  right_uncrossable_boundary_distance_count,
  steering_angle,
  steering_angle_abs,
  steering_rate,
...
static const std::unordered_map<std::string, Metric> str_to_metric = {
  ...
  {"left_uncrossable_boundary_distance_count", Metric::left_uncrossable_boundary_distance_count},
  {"right_uncrossable_boundary_distance", Metric::right_uncrossable_boundary_distance},
  {"right_uncrossable_boundary_distance_count", Metric::right_uncrossable_boundary_distance_count},
...
static const std::unordered_map<Metric, std::string> metric_to_str = {
  ...
  {Metric::left_uncrossable_boundary_distance_count, "left_uncrossable_boundary_distance_count"},
  {Metric::right_uncrossable_boundary_distance, "right_uncrossable_boundary_distance"},
  {Metric::right_uncrossable_boundary_distance_count, "right_uncrossable_boundary_distance_count"},
...
static const std::unordered_map<Metric, std::string> metric_descriptions = {
  ...
  {Metric::left_uncrossable_boundary_distance_count, "Count of left uncrossable boundary distance crossings to <= 0.0m"},
  {Metric::right_uncrossable_boundary_distance_count, "Count of right uncrossable boundary distance crossings to <= 0.0m"},
