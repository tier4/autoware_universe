...
private:
  ...
  // subscribers
  std::vector<AUTOWARE_SUBSCRIPTION_PTR(typename MsgTraits::PointCloudMessage)> pointcloud_subs_;
  ...
  void cloud_callback(
    const AUTOWARE_MESSAGE_SHARED_PTR(const typename MsgTraits::PointCloudMessage) & input_ptr,
