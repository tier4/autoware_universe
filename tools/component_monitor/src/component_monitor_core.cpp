...
: Node("component_monitor", options)
{
    ...
    rclcpp::CallbackGroup::SharedPtr loc_callback_group = this->create_callback_group(rclcpp::CabllbackGroupType::MutuallyExclusive);
    ...
    loc_pose_sub_ = this->create_subscription<geometry_msgs::msg::PoseWithCovarianceStamped>(
        ...
        std::bind(&ComponentMonitor::callback_loc_pose, this, std::placeholders::_1),
        loc_sub_opt
    );
    ...
    loc_tp_sub_ = this->create_subscription<autoware_internal_debug_msgs::msg::Float32Stamped>(
        ...
        std::bind(&ComponentMonitor::callback_loc_tp, this, std::placeholders::_1),
        loc_sub_opt
    );
    ...
    loc_nvtl_sub_ = this->create_subscription<autoware_internal_debug_msgs::msg::Float32Stamped>(
        ...
        std::bind(&ComponentMonitor::callback_loc_nvtl, this, std::placeholders::_1),
        loc_sub_opt
    );
    ...
    score_loader_client_ = this->create_client<autoware_map_msgs::srv::GgetDifferentialScoreMap>("score_loader_service");
}



void ComponentMonitor::callback_loc_pose(geometry_msgs::msg::PoseWithCovarianceStamped::ConstSharedPtr pose_msg_ptr)
{
    ...
    auto result = pcd_loader_client_->async_send_request(request, [](rclcpp::Client<autoware_map_msgs::srv::GetDifferentialScoreMap>::SharedFuture));
...
void ComponentMonitor::callback_loc_tp(autoware_internal_debug_msgs::msg::Float32Stamped::ConstSharedPtr tp_msg_ptr)
{
...
void ComponentMonitor::callback_loc_nvtl(autoware_internal_debug_msgs::msg::Float32Stamped::ConstSharedPtr nvtl_msg_ptr)
{
    // Find the closest pose
    int pose_id = find_stamp(tp_stamp, pose_buffer_);
...
void ComponentMonitor::callback_loc_sensor_points(geometry_msgs::msg::PointCloud2::ConstSharedPtr sensor_points_msg_ptr)
{
    ...
    sensor_points_buffer_.enqueue(std::make_pair(rclcpp::Time(sensor_points_msg_ptr->header.stamp), pcl_cloud));
}
