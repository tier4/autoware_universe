#ifndef AUTOWARE_COMPONENT_MONITOR_HPP_
#define AUTOWARE_COMPONENT_MONITOR_HPP_
...
public:
  ...
  bool is_full()
  {
    return (ele_num_ == MAX_QUEUE_SIZE_);
  }
...
private:
  int idx_convert(int i)
  {
    if (i >= ele_num_) {
      ...
      msg << "Out-of-bound queue access. Accessing index: " << i << " number of elements: " << ele_num_ << std::endl;
...
public:
    ...
    void callback_loc_pose(geometry_msgs::msg::PoseWithCovarianceStamped::ConstSharedPtr pose_msg_ptr);
    void callback_loc_tp(autoware_internal_debug_msgs::msg::Float32Stamped::ConstSharedPtr tp_msg_ptr);
    void callback_loc_nvtl(autoware_internal_debug_msgs::msg::Float32Stamped::ConstSharedPtr nvtl_msg_ptr);
    void callback_loc_sensor_points(geometry_msgs::msg::PointCloud2::ConstSharedPtr sensor_points_msg_ptr);
...
private:
    ...
    std::unordered_map<Eigen::Vector2i, std::unordered_map<Eigen::Vector2i, std::pair<int, float>>> avg_tp_map_;
};
