...
* fix(default_ad_api): fix unusedFunction (`#8581 <https://github.com/tier4/autoware.universe/issues/8581>`_)
  * fix: unusedFunction
  * Revert "fix: unusedFunction"
  This reverts commit c70a36d4d29668f02dae9416f202ccd05abee552.
  * fix: unusedFunction
...
* Contributors: Esteve Fernandez, Hayate TOBA, Kyoichi Sugahara, M. Fatih Cırıt, Satoshi OTA, Takagi, Isamu, Yutaka Kondo
