...
* feat(mrm_emergency_stop_operator): add support for real time param reconfigure for mrm_emergency_stop (`#6994 <https://github.com/autowarefoundation/autoware_universe/issues/6994>`_)
...
* docs(mrm_emergency_stop_operator): fix file name (`#4226 <https://github.com/autowarefoundation/autoware_universe/issues/4226>`_)
