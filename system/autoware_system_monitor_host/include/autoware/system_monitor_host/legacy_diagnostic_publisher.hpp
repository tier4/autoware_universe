...
#ifndef AUTOWARE__SYSTEM_MONITOR_HOST__LEGACY_DIAGNOSTIC_PUBLISHER_HPP_
#define AUTOWARE__SYSTEM_MONITOR_HOST__LEGACY_DIAGNOSTIC_PUBLISHER_HPP_
...
public:
  ...
  void publish(
    rclcpp::Node * node, const std::vector<diagnostic_msgs::msg::DiagnosticStatus> & statuses)
  {
    if (statuses.empty()) {
      return;
    }
...
#endif  // AUTOWARE__SYSTEM_MONITOR_HOST__LEGACY_DIAGNOSTIC_PUBLISHER_HPP_
