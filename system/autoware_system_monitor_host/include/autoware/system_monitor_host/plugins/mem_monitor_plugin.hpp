...
#ifndef AUTOWARE__SYSTEM_MONITOR_HOST__PLUGINS__MEM_MONITOR_PLUGIN_HPP_
#define AUTOWARE__SYSTEM_MONITOR_HOST__PLUGINS__MEM_MONITOR_PLUGIN_HPP_
...
class MemMonitorPlugin : public MonitorPluginBase
{
public:
  MemMonitorPlugin() = default;
  ~MemMonitorPlugin() override = default;
...
private:
  ...
  rclcpp::Publisher<tier4_external_api_msgs::msg::MemoryStatus>::SharedPtr pub_mem_;

  int available_size_mb_{1024};
  float mem_usage_{0.0};
  mutable std::mutex mutex_;
};

}  // namespace autoware::system_monitor_host::plugin

#endif  // AUTOWARE__SYSTEM_MONITOR_HOST__PLUGINS__MEM_MONITOR_PLUGIN_HPP_
