...
def assert_M2_M5(test_instance, diag_err_msgs):
    ...
    test_instance.assertTrue(
        exist_and_timeout, "M2/M5 Failed: Target node does not exist, or it is not a timeout (Single Point Fault)."
    )
...
def assert_M3_M4(test_instance, diag_err_msgs):
    ...
    test_instance.assertTrue(success_condition, "M3/M4 Failed: Target node exists during manual driving, or a timeout was detected.")
...
def assert_M6(test_instance, diag_err_msgs):
    ...
    test_instance.assertTrue(success_condition, "M6 Failed: Target node does not exist, or a timeout was detected during normal operation (10Hz).")
