...
-------------------
* Merge remote-tracking branch 'origin/main' into tmp/bot/bump_version_base
* feat(autoware_goal_distance_calculator)!:  tier4_debug_msgs to autoware_internal_debug_msgs for autoware_goal_distance_calculator (`#9833 <https://github.com/autowarefoundation/autoware_universe/issues/9833>`_)
...
-------------------
* unify package.xml version to 0.37.0
* refactor(goal_distance_calculator): prefix package and namespace with autoware (`#9172 <https://github.com/autowarefoundation/autoware_universe/issues/9172>`_)
