...
#ifndef AUTOWARE__DEPRECATED__BOUNDARY_DEPARTURE_CHECKER__PARAMETERS_HPP_
#define AUTOWARE__DEPRECATED__BOUNDARY_DEPARTURE_CHECKER__PARAMETERS_HPP_
...
struct Param
{
  ...
  std::vector<FootprintType> footprint_types_to_check{FootprintType::NORMAL};
...
#endif  // AUTOWARE__DEPRECATED__BOUNDARY_DEPARTURE_CHECKER__PARAMETERS_HPP_
