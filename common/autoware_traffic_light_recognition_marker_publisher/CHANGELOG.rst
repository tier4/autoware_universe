...
* refactor(traffic_light_recognition_marker_publisher): prefix package and namespace with autoware (`#9305 <https://github.com/autowarefoundation/autoware_universe/issues/9305>`_)
...
* docs(common): adding .pages file (`#7148 <https://github.com/autowarefoundation/autoware_universe/issues/7148>`_)
...
0.26.0 (2024-04-03)
-------------------
* feat: add visualization node of traffic light recognition result (`#4099 <https://github.com/autowarefoundation/autoware_universe/issues/4099>`_)
