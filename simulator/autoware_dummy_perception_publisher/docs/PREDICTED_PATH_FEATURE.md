...
This feature branch (`feat/dummy-object-predicted-path-awf`) adds the capability for dummy objects created in RViz to follow predicted trajectories from the perception system instead of simple straight-line motion. This provides more realistic object movement in simulations by leveraging the predicted paths generated by Autoware's perception pipeline.
