...
- `include/autoware/dummy_perception_publisher/node.hpp`: New member functions and data structures
...
- The node logs mapping changes and validation results
- Use `ros2 topic echo` to inspect the published objects
- Check logs for validation failures to tune parameters
