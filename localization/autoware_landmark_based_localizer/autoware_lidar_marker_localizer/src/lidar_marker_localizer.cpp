  ...
  const PointCloud2::ConstSharedPtr & points_msg_ptr)
{
  ...
  std::vector<pcl::PointCloud<autoware::point_types::PointXYZIRCT>> ring_points(128);

  float min_x = std::numeric_limits<float>::max();
  float max_x = std::numeric_limits<float>::lowest();
  for (const autoware::point_types::PointXYZIRCT & point : points_ptr->points) {
  ...
  // for each channel
  for (const pcl::PointCloud<autoware::point_types::PointXYZIRCT> & one_ring : ring_points) {
    ...
    for (const autoware::point_types::PointXYZIRCT & point : one_ring.points) {
  ...
  const geometry_msgs::msg::Pose marker_pose) const
{
  ...
  pcl::shared_ptr<pcl::PointCloud<autoware::point_types::PointXYZIRCT>> points_ptr(
    new pcl::PointCloud<autoware::point_types::PointXYZIRCT>);
  pcl::fromROSMsg(*points_msg_ptr, *points_ptr);

  pcl::shared_ptr<pcl::PointCloud<autoware::point_types::PointXYZIRCT>> marker_points_ptr(
    new pcl::PointCloud<autoware::point_types::PointXYZIRCT>);
  ...
  const sensor_msgs::msg::PointCloud2::SharedPtr & points_msg_ptr)
{
  ...
  // convert from ROSMsg to PCL
  pcl::shared_ptr<pcl::PointCloud<autoware::point_types::PointXYZIRCT>>
    marker_points_sensor_frame_ptr(new pcl::PointCloud<autoware::point_types::PointXYZIRCT>);
