...
class ViewPlot(Node):
    def __init__(self):
        ...
        self.declare_parameter("log_file", package_path + "/config/acc_cmd_test_log.csv")
        ...
        #     min_vel_thr, max_steer_thr, max_pitch_thr, max_jerk_thr)
        ...
        plotter.add_label("average of accel", "velocity(kmh)", "acc_cmd")
        ...
        plotter.add_label("std. dev. of accel", "velocity(kmh)", "acc_cmd")
        ...
        plotter.add_label("number of accel data", "velocity(kmh)", "acc_cmd")
        plotter.show()
