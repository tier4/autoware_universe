...
class ConstantAccelerationTester(Node):
    def __init__(self):
        super().__init__("constant_acceleration_tester")
        self.pub = self.create_publisher(Float32Stamped, "/control/tester/target_acceleration", 1)
...
def main(args=None):
    ...
    tester = ConstantAccelerationTester()
    tester.run()
