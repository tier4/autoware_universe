...
* chore(package.xml): bump version to 0.38.0 (`#9266 <https://github.com/tier4/autoware.universe/issues/9266>`_) (`#9284 <https://github.com/tier4/autoware.universe/issues/9284>`_)
  ...
  * 0.38.0
  ---------
* feat(collision_detector): use polling subscriber (`#9213 <https://github.com/tier4/autoware.universe/issues/9213>`_)
  use polling subscriber
* chore(collision_detector): add maintainer  (`#9184 <https://github.com/tier4/autoware.universe/issues/9184>`_)
  add maintainer
* feat(collision_detector): add autoware_collision_detector (`#9157 <https://github.com/tier4/autoware.universe/issues/9157>`_)
  * add new package autoware_collision_detector
  * update to latest
  * fix
  * fix reference
  ...
  * change description for parameters
  ---------
* Contributors: Esteve Fernandez, Go Sakayori, M. Fatih Cırıt, Yutaka Kondo
