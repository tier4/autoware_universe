...
* chore(package.xml): bump version to 0.38.0 (`#9266 <https://github.com/tier4/autoware.universe/issues/9266>`_) (`#9284 <https://github.com/tier4/autoware.universe/issues/9284>`_)
  ...
  * 0.38.0
  ---------
* feat(control_validator): add hold and lpf (`#9120 <https://github.com/tier4/autoware.universe/issues/9120>`_)
...
* fix(control): align the parameters with launcher (`#8789 <https://github.com/tier4/autoware.universe/issues/8789>`_)
  align the control parameters
* feat(autoware_control_validator): refactoring & testing (`#8096 <https://github.com/tier4/autoware.universe/issues/8096>`_)
  * refactoring
  * updating...
  * update
  * fix
  ...
  * use yaml to load vehicle info
  ---------
* fix(control_validator): fix param names and doc (`#8104 <https://github.com/tier4/autoware.universe/issues/8104>`_)
  * fix
* feat(control_validator)!: add velocity check (`#7806 <https://github.com/tier4/autoware.universe/issues/7806>`_)
  * add velocity check
  ---------
...
* refactor(control)!: refactor directory structures of the control checkers (`#7524 <https://github.com/tier4/autoware.universe/issues/7524>`_)
  ...
  * fix
  ---------
* feat(autoware_control_validator): add polling subcribers (`#7426 <https://github.com/tier4/autoware.universe/issues/7426>`_)
  * add polling subs
  * delete extra line
  ---------
* fix(autoware_control_validator): fix vehicle info utils (`#7417 <https://github.com/tier4/autoware.universe/issues/7417>`_)
* refactor(control_validator)!: prefix package and namespace with autoware (`#7304 <https://github.com/tier4/autoware.universe/issues/7304>`_)
  ...
  * delete stubborn file
  ---------
* Contributors: Esteve Fernandez, Fumiya Watanabe, Kazunori-Nakajima, Kosuke Takeuchi, M. Fatih Cırıt, Ryuta Kambe, Takayuki Murooka, Yuki TAKAGI, Yukinari Hisaki, Yutaka Kondo, Zhe Shen, danielsanchezaran, ぐるぐる
