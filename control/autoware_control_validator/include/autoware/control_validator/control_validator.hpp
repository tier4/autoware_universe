...
public:
  ...
  {
    enable_ = params.boundary_departure.enable;
    checker_params_.lateral_margin_m = params.boundary_departure.lateral_margin_m;
    checker_params_.longitudinal_margin_m = params.boundary_departure.longitudinal_margin_m;
    checker_params_.max_deceleration_mps2 = params.boundary_departure.max_deceleration_mps2;
    checker_params_.max_jerk_mps3 = params.boundary_departure.max_jerk_mps3;
    checker_params_.brake_delay_s = params.boundary_departure.brake_delay_s;
    checker_params_.time_to_departure_cutoff_s =
      params.boundary_departure.time_to_departure_cutoff_s;
    checker_params_.on_time_buffer_s = params.boundary_departure.on_time_buffer_s;
    checker_params_.off_time_buffer_s = params.boundary_departure.off_time_buffer_s;
    checker_params_.enable_developer_marker = params.boundary_departure.enable_developer_marker;
    checker_params_.boundary_types_to_detect = params.boundary_departure.boundary_types;
    if (checker_) {
...
private:
  bool enable_{true};
  rclcpp::Logger logger_;
  boundary_departure_checker::UncrossableBoundaryDepartureParam checker_params_;
