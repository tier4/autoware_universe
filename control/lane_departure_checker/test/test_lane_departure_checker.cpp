...
vehicle_info_util::VehicleInfo createVehicleInfo(
  double wheel_base, double front_overhang, double rear_overhang, double wheel_tread,
  double left_overhang, double right_overhang)
{
...
TEST(LaneDepartureChecker, CreateVehicleFootprints)
{
  ...
  auto vehicle_info = createVehicleInfo(
    wheel_base, front_overhang, rear_overhang, wheel_tread, left_overhang, right_overhang);
  ...
  std::array<double, 2> q0 = {
    (root3 * p0[0] - p0[1]) / 2.0 + 2.0, (p0[0] + root3 * p0[1]) / 2.0 + 5.0};
  std::array<double, 2> q1 = {
    (root3 * p1[0] - p1[1]) / 2.0 + 2.0, (p1[0] + root3 * p1[1]) / 2.0 + 5.0};
  std::array<double, 2> q2 = {
    (root3 * p2[0] - p2[1]) / 2.0 + 2.0, (p2[0] + root3 * p2[1]) / 2.0 + 5.0};
  std::array<double, 2> q3 = {
    (root3 * p3[0] - p3[1]) / 2.0 + 2.0, (p3[0] + root3 * p3[1]) / 2.0 + 5.0};
  std::array<double, 2> q4 = {
    (root3 * p4[0] - p4[1]) / 2.0 + 2.0, (p4[0] + root3 * p4[1]) / 2.0 + 5.0};
  std::array<double, 2> q5 = {
    (root3 * p5[0] - p5[1]) / 2.0 + 2.0, (p5[0] + root3 * p5[1]) / 2.0 + 5.0};
