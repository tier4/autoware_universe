...
void OperationModeTransitionManager::changeOperationMode(std::optional<OperationMode> request_mode)
{
  ...
  const bool current_control = (control_mode_report_.mode == ControlModeReport::AUTONOMOUS || control_mode_report_.mode == ControlModeReport::AUTONOMOUS_VELOCITY_ONLY || control_mode_report_.mode == ControlModeReport::AUTONOMOUS_STEER_ONLY );
